...
module.exports = strapi => (
  {
    ...
    async initialize() {
      ...
      const settings = {...this.defaults, ...strapi.config.hook.settings.algolia};
      ...
      if (settings.debug) strapi.log.debug(`Successfully initialized Algolia service with the settings: ${JSON.stringify(settings)}`);
